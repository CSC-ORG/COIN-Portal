...
<?php
		if(isset($_POST['submit']))
				  ...
				  for($i=0;$i<$count;$i++)
					...
					$q3= "UPDATE std_list SET `name`='".$name."', `username`='".$username."',`password`='".$password."',`email`='".$email."',`contact`='".$contact."',`college`='".$college."'
					    WHERE `id`= ".$id."";
			...
			<?php  
						...
						{
							$mid = $_POST["id"];
							$q2= "DELETE FROM `std_list`  WHERE `id`= '".$mid."' ";
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						...
						$q="SELECT * FROM `std_list` ORDER BY id ASC " ;
        ...
        <input name=\"college".$j."\"\" style=\" width:100px ;\" type=\"text\"  value=\"".$r[8]."\" >
			...
			<div style="margin-left:-40px;margin-top:100px;margin-right:-50px;margin-bottom:-70px;">
