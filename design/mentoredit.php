...
if(isset($_POST["save"]))
{
	...
	$email=$_POST["email"];
				...
				$q="UPDATE `mentor_details` SET `email`='".$email."',`contact`='".$contact."' WHERE  username='" . $_SESSION['username_mentor'] . "'";
...
<head>
	...
	<title>EDIT MENTOR INFORMATION</title>
...
<p class="wel" style="margin-left:1150px"><b>WELCOME</b> &nbsp<span><?php echo "<font face=\"Comic sans MS\" size=\"4\">" . $_SESSION['username_mentor'] . "</font>"?></span></p>			   
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Edit Mentor Details</li>
		</ol>
			...
			<?php
				...
				$q="SELECT * FROM `mentor_details` where username='" . $_SESSION['username_mentor'] . "'";
				$data=mysql_query($q,$cn);
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title text-center">EDIT MENTOR DETAILS</h1>
				</header>
				<h4 align=center>CHANGE MENTOR INFORMATION</h4>
				<form method="POST">
				<?php
				if($data<1)
				{
				...
				<table class="table table-bordered">
					...
					<tr class="row">
						...
						<td class='col-xs-4'>
							<input type="text" name="contact" value="<?php echo $r[7];?>" class="form-control">
						</td>
					</tr>
				...
				<button class="btn btn-action" name="pass" type="submit"><a href ="mentor_pass_chng.php">CHANGE PASSWORD</a></button>
			</a>
