				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="mentoredit.php">Edit Profile</a></li>
							<li><a href="mentor_pass_chng.php">Change Password</a></li>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<?php
				...
				{
				$q2="SELECT password FROM `reviewer_details`  WHERE  username='" . $_SESSION['username_review'] . "'";
				...
				{
				$q3="UPDATE `reviewer_details` SET `password`='".$npassword."' WHERE  username='" . $_SESSION['username_review'] . "'";
