...
<?php
		if(isset($_POST['submit']))
				  ...
				  for($i=0;$i<$count;$i++)
					...
					$q3= "UPDATE spoc_details SET `name`='".$name."', `username`='".$username."',`password`='".$password."',`email`='".$email."',`contact`='".$contact."',`college`='".$college."'
					    WHERE `id`= ".$id."";
...
<?php  
						...
						{
							$mid = $_POST["id"];
							$q2= "DELETE FROM `spoc_details`  WHERE `id`= '".$mid."' ";
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						...
						$q="SELECT * FROM `spoc_details` ORDER BY id ASC " ;
        ...
        <input name=\"email".$j."\"\" style=\" width:100px ;\"type=\"text\"  value=\"".$r[6]."\" >
        ...
        <input name=\"college".$j."\"\" style=\" width:100px ;\" type=\"text\"  value=\"".$r[7]."\" >
			...
			<div style="margin-left:-40px;margin-top:60px;margin-right:-50px;margin-bottom:-70px;">
